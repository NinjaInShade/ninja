        ...
        <div class="outer-flex">
            <div>
                <header>
                    ...
                    <div class="buttons">
                        <NW.Button theme="primary-400" onClick={() => NW.nav.go('/docs')} size="L">View docs</NW.Button>
                        <NW.Button theme="white" icon="brands fa-github" textColor="var(--black)" iconColor="var(--black)" size="L">Source code</NW.Button>
                    </div>
                </header>
